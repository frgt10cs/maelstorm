...
namespace Maelstorm.Services.Interfaces
{
    public interface IDialogService
    {
        ...
        Task<IEnumerable<Message>> GetReadedMessagesAsync(long userId, long dialogId, int offset, int count);
        Task<IEnumerable<Message>> GetUnreadedMessagesAsync(long userId, long dialogId, int offset, int count);
